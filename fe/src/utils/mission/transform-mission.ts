...
import type { Mission } from "@/types/generated/api-schema";
import type {
  MissionListItem,
  MissionResponse,
 ...
 * @param mission - API 응답의 미션 데이터 (Mission 또는 MissionResponse)
 ...
 * @param missions - API 응답의 미션 배열 (Mission[] 또는 MissionResponse[])
 * @returns MissionListCard에 전달할 형식의 미션 배열
 */
export const transformMissionsToListItems = (
  missions: (Mission | MissionResponse)[]
): MissionListItem[] => {
