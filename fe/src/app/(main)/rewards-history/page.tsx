    ...
    <>
      ...
      {isGuideOpen && (
        <div className="fixed inset-0 z-[999] bg-black/70">
          ...
          />
          <div className="absolute inset-x-0 bottom-0 z-[1000] rounded-t-3xl bg-white px-6 pb-10 pt-4">
            <div className="mx-auto mb-4 h-1.5 w-14 rounded-full bg-gray-200" />
            <h2 className="text-lg font-semibold text-gray-900">나다움 가이드</h2>
            <ol className="mt-4 space-y-3 text-sm leading-6 text-gray-600">
              ...
              <li>
                4. 나다움은 제 3자에게 양도할 수 없으며 유상으로 거래하거나 현금으로
                전환할 수 없습니다.
              </li>
              <li>
